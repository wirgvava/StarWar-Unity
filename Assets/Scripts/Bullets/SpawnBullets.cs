...
public class SpawnBullets : MonoBehaviour
{
    ...
    void Spawn()
    {
        ...
        {
            Vector3 position = new Vector3(player.transform.position.x, player.transform.position.y + 0.65f, player.transform.position.z);
        ...
        {
            Vector3 position = new Vector3(player.transform.position.x, player.transform.position.y + 1.1f, player.transform.position.z);
        ...
        {
            Vector3 position = new Vector3(player.transform.position.x, player.transform.position.y + 1.05f, player.transform.position.z);
